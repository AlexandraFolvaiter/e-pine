...
public class BookingService : BaseService, IBookingService
{
    ...
    public IList<TeamMember> GetTeamMembers(Guid merchantId)
    {
        ...
        var teamMembers = client?
            .TeamApi
            .SearchTeamMembers(new SearchTeamMembersRequest())
            .TeamMembers;
    ...
    public IList<Availability> SearchAvailabilities(BookingCreateModel model)
    {
        ...
        var body = GetSearchAvailabilityRequest(model);

        var client = _squareConnection.GetSquareClient(merchant?.AccessToken);

        var availabilities = client?
            .BookingsApi
            .SearchAvailability(body)
            .Availabilities;
    ...
    public void CreateAppointment(Guid userId, BookingCreateModel model)
    {
        ...
        var client = _squareConnection.GetSquareClient(merchant.AccessToken);
        var customerId = GetCustomerId(userId, client);
        var body = GetCreateBookingRequest(model, customerId);
    ...
    public void CancelAppointment(Guid appointmentId)
    {
        ...
        var client = _squareConnection.GetSquareClient(merchant?.AccessToken);
        var body = new CancelBookingRequest.Builder().Build();
    ...
    public AppointmentDetails GetBooking(Guid appointmentId)
    {
        ...
        {
            Booking = booking,
            AppointmentModel = localAppointment.ToModel(),
    ...
    private static SearchAvailabilityRequest GetSearchAvailabilityRequest(BookingCreateModel model)
    {
    ...
    private static CreateBookingRequest GetCreateBookingRequest(BookingCreateModel model, string customerId)
    {
